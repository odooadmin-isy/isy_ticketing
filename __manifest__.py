# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/communication_request_view.xml',
        'views/vehicle_generator_logbook_view.xml',
        'views/vehicle_generator_logbook_portal_template.xml',
        'views/generator_usage_logbook_view.xml',
        'views/generator_usage_logbook_portal_template.xml',
        'views/transportation_logbook_view.xml',
        'views/transportation_logbook_portal_template.xml',
